...
The project is an Arduino powered 16x16 LED Matrix using the [FastLED](https://fastled.io/) library to drive a WS2812B LED array. This could be used to display a variety of fun light displays. I am currently using it to display a variety of classic arcade sprites.
